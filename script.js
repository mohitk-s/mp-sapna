...
const music_list = [
    {
        cover: 'https://i.postimg.cc/yNcbVk22/IMG-20240207-WA0025.jpg',
        name: 'MONTA RE',
...
function loadTrack(track_index) {
    ...
    // Show image cover for the first track, otherwise show video
    if (track_index === 0) {
        video_player.style.display = 'none';
        image_cover.style.display = 'block';
        image_cover.src = music_list[track_index].cover;
    } else {
